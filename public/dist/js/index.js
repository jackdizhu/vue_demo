...
/******/ 	var parentJsonpFunction = window["webpackJsonpjs__name__js"];
/******/ 	window["webpackJsonpjs__name__js"] = function webpackJsonpCallback(chunkIds, moreModules, executeModules) {
...
exports.default = [{
    ...
    children: [{
        ...
        component: function component(resolve) {
            return __webpack_require__.e/* require */(2).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(24)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
        }
    }, {
        path: '/signout', //退出
        component: function component(resolve) {
        ...
        meta: { auth: false },
        component: function component(resolve) {
            return __webpack_require__.e/* require */(0).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(26)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
        }
    }, {
        path: '*', //其他页面，强制跳转到登录页面
        redirect: '/login'
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_210b12b6_hasScoped_true_node_modules_vue_loader_lib_selector_type_template_index_0_app_vue__ = __webpack_require__(16);
var disposed = false
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_51a47eac_hasScoped_true_node_modules_vue_loader_lib_selector_type_template_index_0_header_vue__ = __webpack_require__(23);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
